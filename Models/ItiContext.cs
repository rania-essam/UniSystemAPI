    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Student>(entity =>
        {
            ...
            entity.Property(e => e.StId)
                ...
                .HasColumnName("St_Id");
            entity.Property(e => e.DeptId).HasColumnName("Dept_Id");
            entity.Property(e => e.NewId).ValueGeneratedOnAdd();
        ...
        {
            entity.HasKey(e => e.StId).HasName("PK_Student2");
            ...
            entity.HasOne(d => d.Dept).WithMany(p => p.Student2s)
                .HasForeignKey(d => d.DeptId)
                .HasConstraintName("FK_Student_Dept");

            entity.HasOne(d => d.StSuperNavigation).WithMany(p => p.Student2s)
                .HasForeignKey(d => d.StSuper)
